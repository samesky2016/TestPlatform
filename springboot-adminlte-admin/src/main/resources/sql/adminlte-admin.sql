...
INSERT INTO `sys_menu` VALUES ('9', '测试管理', '0', null, 'fa fa-graduation-cap', '1', '1', '09', null);
...
CREATE TABLE `mock` (
  `id` varchar(50) NOT NULL COMMENT '主键',
  `mockName` varchar(100) DEFAULT NULL COMMENT '接口名称',
  `comment` varchar(100) DEFAULT NULL,
  `contenttype` varchar(100) DEFAULT NULL,
  `createTime` datetime NOT NULL,
  `responseParameter` text COMMENT '响应参数',
  `path` varchar(100) DEFAULT NULL,
  `projectId` varchar(50) NOT NULL COMMENT '项目主键',
  `responseCode` varchar(16) DEFAULT '200' COMMENT '返回码',
