...
public class KafkaWebSocket {
	...
	@Autowired
	protected ConsumerRecordService consumerRecordService;
	@Autowired
	protected ConsumerRecord consumerRceord;
...
//			Map<String, String> record = JSON.parseObject(message, Map.class);
//			consumerRceord.setItemId(record.get("itemId"));
//			consumerRceord.setTopic("mb.park.in");
//			consumerRceord.setContent(message);
//			consumerRceord.setCreateTime(new Date());
//
//			consumerRecordService.insert(consumerRceord);
...
//			Map<String, String> record = JSON.parseObject(message, Map.class);
//			consumerRceord.setItemId(record.get("itemId"));
//			consumerRceord.setTopic("mb.park.out");
//			consumerRceord.setContent(message);
//			consumerRceord.setCreateTime(new Date());
//
//			consumerRecordService.insert(consumerRceord);
