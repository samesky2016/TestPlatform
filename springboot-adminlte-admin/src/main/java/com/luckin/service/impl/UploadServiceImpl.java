...
public class UploadServiceImpl {
	...
	public String uploadImg(String imgurl) {
		...
		return uploadImg(OkHttpUtil.getBytes(imgurl, imgurl));
	}
	...
	public String uploadImg(byte[] bytes) {
		// 上传图片
		String result = OkHttpUtil.postJpg(uploadUrl + tokenService.getAccessToken(), bytes);
	...
	public String uploadhumb(String imgurl) {
		...
		// 下载图片并上传
		String result = OkHttpUtil.postJpg(thumbUrl + tokenService.getAccessToken(), OkHttpUtil.getBytes(imgurl, imgurl));
