...
import com.luckin.common.bean.ArticleBean;
import com.luckin.common.bean.ArticleInfoBean;
import com.luckin.common.bean.ArticleSendBean;
import com.luckin.common.bean.WeixinResultBean;
...
public class PushServiceImpl {
	...
	public boolean publish() {
		...
		String result = OkHttpUtil.postJson(sendUrl + tokenService.getAccessToken(), JsonUtil.toJson(sendBean));
	...
	public boolean preview() {
		...
		String result = OkHttpUtil.postJson(previewUrl + tokenService.getAccessToken(), body);
	...
	private String addNews() {
		...
		byte[] bytes = OkHttpUtil.getBytes(oldurl, oldurl);
		...
		String result = OkHttpUtil.postJson(newsUrl + tokenService.getAccessToken(), json);
